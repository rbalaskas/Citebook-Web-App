...
const Left_sidebar=(props) =>{
  ...
  useEffect(()=>{
     ...
     if(props.picture!="posts_pdf/profile_pic.jpg"){
      console.log("diaforetiko apo null");
    ...
    >
        ...
        {props.random_posts && 
      props.random_posts.slice(0,2).map((post,index) =>(
...
export default connect(mapStateToProps,{get_Info,click_left_sidebar,get_posts})(Left_sidebar)