...
import { Button, Form, Grid, Header, Image, Message, Segment,Checkbox,Container } from 'semantic-ui-react';
...
const LogIn = (props) => {
   ...
   const signInClick = async () =>{ //get request to check validation je meta dispatch sign in
   ...
   <Header as='h2' block color='teal' textAlign='center'>
        <Image src="http://localhost:8000/posts_pdf/logo.png" /> Log-in to your account
      </Header>
      <Form  size='large'>
        <Segment stacked>
          <Form.Input 
